...
import { ActaExtranjeriaPreviewModal } from "@/components/actas-extranjeria/ActaExtranjeriaPreviewModal";
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                    {watch("numeroActa") &&
                        watch("fechaActa") &&
                        watch("profesorId") && (
                            <ActaExtranjeriaPreviewModal
                                acta={{
                                    id: "preview",
                                    numeroActa: watch("numeroActa"),
                                    ano: watch("ano"),
                                    fechaActa: watch("fechaActa"),
                                    funcion: watch("funcion"),
                                    ...
                                    profesor: profesores.find(
                                        (p) => p.id === watch("profesorId"),
                                    ),
                                    paisDestino: paises.find(
                                        (p) => p.id === watch("paisDestinoId"),
                                    ),
                                }}
                        ...
                        <div className="grid gap-6 md:grid-cols-3">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    {...register("fechaActa")}
                                    className={
                                        errors.fechaActa ? "border-red-500" : ""
                                    }
                                />
                                {errors.fechaActa && (
                                    <p className="text-xs text-red-500">
